                ...
                <div class="page-header" >
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <h4>联系地址：成都红牌楼佳灵路10号 </h4>
                            <h4>联系电话：18982280521 </h4>
                            <h4>联系QQ：239976281 </h4>
                            <h4>联系Email：dongfang.x@qq.com </h4>
                            <h4>地图位置： </h4>
                            <div>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(104.03578,30.639822);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"六亿科技",content:"六亿科技地图位置",point:"104.035488|30.639589",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
    ];
    //创建marker
    function addMarker(){
