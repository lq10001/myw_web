				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
                            ...
                            <li><a href="<%=path%>/product" target="navTab" rel="product">产品管理</a></li>


                            <li><a href="<%=path%>/sys/employee/list" target="navTab" rel="employee">信息管理</a></li>
							<li><a href="<%=path%>/sys/employee/list" target="navTab" rel="employee">产品管理</a></li>
							<li><a href="<%=path%>/sys/employee/list" target="navTab" rel="employee">资料管理</a></li>
							<li><a href="<%=path%>/sys/employee/list" target="navTab" rel="employee">模板管理</a></li>
						</ul>
					</div>
				</div>
			</div>
